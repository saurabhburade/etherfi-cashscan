...
export function renderPatternPreset(
  ...
  switch (preset) {
    case "diagonal":
      return <PatternLines {...common} orientation={["diagonal"]} stroke={color} strokeWidth={strokeWidth} />;
    case "horizontal":
      return <PatternLines {...common} orientation={["horizontal"]} stroke={color} strokeWidth={strokeWidth} />;
    case "vertical":
      return <PatternLines {...common} orientation={["vertical"]} stroke={color} strokeWidth={strokeWidth} />;
    case "cross":
      return (
        <PatternLines
          {...common}
    ...
    case "accent":
      return <PatternLines {...common} orientation={["diagonal"]} stroke="#e879f9" strokeWidth={strokeWidth} />;
    default:
      return null;
  }
}
